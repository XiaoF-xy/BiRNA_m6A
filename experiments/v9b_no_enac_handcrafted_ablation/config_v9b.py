...
def get_overrides(dataset_name: str, seed: int) -> dict:
    return {
        "experiment": {
            "version_name": "v9b_no_enac_handcrafted_ablation",
            "description": "v9a ablation without ENAC: BiRNA v7b plus ONEHOT/NCP/EIIP handcrafted CNN.",
        },
        "model": {
            ...
            "handcrafted_feature_names": ["onehot", "ncp", "eiip"],
