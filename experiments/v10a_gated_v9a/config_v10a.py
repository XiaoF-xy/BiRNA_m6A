...
def get_overrides(dataset_name: str, seed: int) -> dict:
    return {
        "experiment": {
            "version_name": "v10a_gated_v9a",
            "description": (
                "v9a BiRNA-BERT v7b branch and handcrafted physicochemical branch "
                "fused by a learnable vector gate instead of simple concatenation."
            ),
        },
        "model": {
